...
CALL create_turnos('2024-06-23', '2024-07-23', 7, 120, '08:00:00');
...
BEGIN
    DECLARE v_COD_ACTIVIDAD INT DEFAULT 0;
    DECLARE v_COD_CRONOGRAMA INT DEFAULT 0;
    DECLARE v_FECHA_INSCRIPCION DATE;
    DECLARE v_COD_TURNO INT DEFAULT 0;
    ...
    WHERE CR.COD_CRONOGRAMA = v_COD_CRONOGRAMA
		AND CR.COD_ACTIVIDAD = v_COD_ACTIVIDAD
		AND CR.COD_TURNO = v_COD_TURNO
    LIMIT 1;
