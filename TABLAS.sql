...
CREATE TABLE SOCIO (
    NRO_SOCIO INT PRIMARY KEY NOT NULL,
...
CREATE TABLE GRUPO_FAMILIAR (
    ...
    COD_CUOTA_MENSUAL INT,
    DOMICILIO VARCHAR(50)
);

ALTER TABLE GRUPO_FAMILIAR
ADD CONSTRAINT FK_SOCIO_TITULAR FOREIGN KEY (NRO_SOCIO_TITULAR) REFERENCES SOCIO(NRO_SOCIO);

ALTER TABLE SOCIO
ADD CONSTRAINT FK_GRUPO FOREIGN KEY (NRO_GRUPO) REFERENCES GRUPO_FAMILIAR(NRO_GRUPO);
...
CREATE TABLE POSEE (
    ...
    PRIMARY KEY (NRO_SOCIO, COD_CATEGORIA, PERIODO_CATEGORIA),
    FOREIGN KEY (NRO_SOCIO) REFERENCES SOCIO(NRO_SOCIO),
    FOREIGN KEY (COD_CATEGORIA) REFERENCES CATEGORIA(COD_CATEGORIA)
);
...
CREATE TABLE SE_INSCRIBE (
    ...
    PRIMARY KEY (NRO_SOCIO, COD_CRONOGRAMA, FECHA_INSCRIPCION),
    FOREIGN KEY (NRO_SOCIO) REFERENCES SOCIO(NRO_SOCIO),
